...
void PrintVillainName(int i)
{
  switch (i)
  {
    case VILLAIN_TROLL:   PrintText("troll");   break;
    case VILLAIN_THIEF:   PrintText("thief");   break;
    case VILLAIN_CYCLOPS: PrintText("cyclops"); break;
  }
}
...
void PrintBlowRemark(int player_flag, int i, int blow, int weapon)
{
  ...
  switch (msg)
  {
    case 100*0 +  0: PrintText("Your "); PrintWeaponName(weapon); PrintText(" misses the "); PrintVillainName(i); PrintText(" by an inch."); break;
    case 100*0 +  1: PrintText("A good slash, but it misses the "); PrintVillainName(i); PrintText(" by a mile."); break;
    case 100*0 +  2: PrintText("You charge, but the "); PrintVillainName(i); PrintText(" jumps nimbly aside."); break;
    case 100*0 +  3: PrintText("Clang! Crash! The "); PrintVillainName(i); PrintText(" parries."); break;
    case 100*0 +  4: PrintText("A quick stroke, but the "); PrintVillainName(i); PrintText(" is on guard."); break;
    case 100*0 +  5: PrintText("A good stroke, but it's too slow; the "); PrintVillainName(i); PrintText(" dodges."); break;
    case 100*0 +  6: PrintText("Your "); PrintWeaponName(weapon); PrintText(" crashes down, knocking the "); PrintVillainName(i); PrintText(" into dreamland."); break;
    case 100*0 +  7: PrintText("The "); PrintVillainName(i); PrintText(" is battered into unconsciousness."); break;
    case 100*0 +  8: PrintText("A furious exchange, and the "); PrintVillainName(i); PrintText(" is knocked out!"); break;
    case 100*0 +  9: PrintText("The haft of your "); PrintWeaponName(weapon); PrintText(" knocks out the "); PrintVillainName(i); PrintText("."); break;
    case 100*0 + 10: PrintText("The "); PrintVillainName(i); PrintText(" is knocked out!"); break;
    case 100*0 + 11: PrintText("It's curtains for the "); PrintVillainName(i); PrintText(" as your "); PrintWeaponName(weapon); PrintText(" removes his head."); break;
    case 100*0 + 12: PrintText("The fatal blow strikes the "); PrintVillainName(i); PrintText(" square in the heart: He dies."); break;
    case 100*0 + 13: PrintText("The "); PrintVillainName(i); PrintText(" takes a fatal blow and slumps to the floor dead."); break;
    case 100*0 + 14: PrintText("The "); PrintVillainName(i); PrintText(" is struck on the arm; blood begins to trickle down."); break;
    case 100*0 + 15: PrintText("Your "); PrintWeaponName(weapon); PrintText(" pinks the "); PrintVillainName(i); PrintText(" on the wrist, but it's not serious."); break;
    case 100*0 + 16: PrintText("Your stroke lands, but it was only the flat of the blade."); break;
    case 100*0 + 17: PrintText("The blow lands, making a shallow gash in the "); PrintVillainName(i); PrintText("'s arm!"); break;
    case 100*0 + 18: PrintText("The "); PrintVillainName(i); PrintText(" receives a deep gash in his side."); break;
    case 100*0 + 19: PrintText("A savage blow on the thigh! The "); PrintVillainName(i); PrintText(" is stunned but can still fight!"); break;
    ...
    case 100*0 + 22: PrintText("The "); PrintVillainName(i); PrintText(" is staggered, and drops to his knees."); break;
    case 100*0 + 23: PrintText("The "); PrintVillainName(i); PrintText(" is momentarily disoriented and can't fight back."); break;
    case 100*0 + 24: PrintText("The force of your blow knocks the "); PrintVillainName(i); PrintText(" back, stunned."); break;
    case 100*0 + 25: PrintText("The "); PrintVillainName(i); PrintText(" is confused and can't fight back."); break;
    case 100*0 + 26: PrintText("The quickness of your thrust knocks the "); PrintVillainName(i); PrintText(" back, stunned."); break;
    case 100*0 + 27: PrintText("The "); PrintVillainName(i); PrintText("'s weapon is knocked to the floor, leaving him unarmed."); break;
    case 100*0 + 28: PrintText("The "); PrintVillainName(i); PrintText(" is disarmed by a subtle feint past his guard."); break;
